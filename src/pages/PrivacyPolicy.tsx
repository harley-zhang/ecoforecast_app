    ...
    return (
        <>
            ...
            <div className="sm:w-[750px] mx-auto px-5">
                ...
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-product-sans-regular mt-8 xs:mt-12 sm:mt-16">2. Children</h3>
                <p className="mt-4 xs:mt-6 font-product-sans-light-regular text-lg">
                    Our Service is not directed to children under the age of 13.
                </p>

                <h3 className="text-xl xs:text-2xl sm:text-3xl font-product-sans-regular mt-8 xs:mt-12 sm:mt-16 ">3. Links to other websites</h3>
                <p className="mt-4 xs:mt-6 font-product-sans-light-regular text-lg">
                ...
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-product-sans-regular mt-8 xs:mt-12 sm:mt-16 ">4. Changes to the privacy policy</h3>
                <p className="mt-4 xs:mt-6 font-product-sans-light-regular text-lg">
