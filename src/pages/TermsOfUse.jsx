    ...
    return (
        <>
            ...
            <div className="sm:w-[750px] mx-auto px-5">
                <p className="text-sm mt-16 xs:mt-24 sm:mt-36  text-grey text-center"><span className="font-product-sans-medium-regular">Effective: </span><span className="font-product-sans-light-regular tracking-wide">July 10, 2024</span></p>
