            ...
            <div className="mx-auto px-5 sm:px-10 md:px-5 md:w-[1088px]">
                ...
                {isAboveSmallScreens ? (
                    ...
                    <>
                        ...
                        {/* LAYER OPTIONS */}
                        <h1 className="text-3xl xs:text-4xl mt-24 xs:mt-28 font-product-sans-regular text-center">Layer options</h1>
                        {/* Plant functional type */}
                        <div className="flex flex-col items-center my-12 relative">
                            <div className="w-full">
                                <div className="bg-greymd p-[6vw] rounded-t-lg flex flex-col justify-center">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={PlantFunctional} alt="Plant functional type" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>
                        {/* Time period and scenario */}
                        <div className="flex flex-col items-center my-12 relative">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={TimePeriod} alt="Time period and scenario" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>
                        {/* Grazing and wildfire */}
                        <div className="flex flex-col items-center my-12 relative">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={GrazingWildfire} alt="Grazing and wildfire" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>

                        {/* AREA OF INTEREST */}
                        <h1 className="text-3xl xs:text-4xl mt-24 xs:mt-28 font-product-sans-regular text-center">Area of interest</h1>
                        {/* Draw a shape */}
                        <div className="flex flex-col items-center my-12 relative">
                            <div className="w-full">
                                <div className="bg-greymd p-[6vw] rounded-t-lg flex flex-col justify-center">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={DrawShape} alt="Draw a shape" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>
                        {/* Produce a rectangle */}
                        <div className="flex flex-col items-center my-12 relative">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={Rectangle} alt="Produce a rectangle" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>

                        {/* DOWNLOADING DATA */}
                        <h1 className="text-3xl xs:text-4xl mt-24 xs:mt-28 font-product-sans-regular text-center">Downloading data</h1>
                        {/* Generate a download link */}
                        <div className="flex flex-col items-center my-12 relative">
                            <div className="w-full">
                                <div className="bg-greymd p-[6vw] rounded-t-lg flex flex-col justify-center">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={Download} alt="Generate a download link" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center my-12 relative">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={DataViewer} alt="Data viewer" className="w-full h-full object-cover rounded-b-lg" />
                                </div>◊
                            </div>
                        </div>
                        {/* Geometry and layers managers */}
                        <div className="flex flex-col items-center my-12 relative">
                            ...
                            <div className="w-full">
                                <div className="w-full overflow-hidden h-[calc(100vw-40px)]">
                                    <img src={Manager} alt="Geometry and layers managers" className="w-full h-full object-cover rounded-b-lg" />
                                </div>
                            </div>
                        </div>
                    </>
